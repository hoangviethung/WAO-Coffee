 ...
 const initIndexBestSeller = () => {
     let indexBestSeller = new Swiper(
         ".slider-index-best-seller .swiper-container", {
             ...
             speed: 1000,
             navigation: {
                 nextEl: ".slider-index-best-seller .button-navigation-slider.next",
                 prevEl: ".slider-index-best-seller .button-navigation-slider.prev",
             },
             breakpoints: {
                 990: {
                     slidesPerView: 2,
 ...
 const initIndexNews = () => {
     ...
     let educateNews = new Swiper(".slider-educate-news .swiper-container", {
         slidesPerView: 1,
         spaceBetween: 35,
         navigation: {
             nextEl: ".slider-educate-news .button-navigation-slider.next",
             prevEl: ".slider-educate-news .button-navigation-slider.prev",
         },
         breakpoints: {
             768: {
                 slidesPerView: 2,
 ...
 const initSetupFeedback = () => {
     ...
     let educateFeedback = new Swiper(".slider-educate-feedback .swiper-container", {
         slidesPerView: 1,
         spaceBetween: 35,
         navigation: {
             nextEl: ".slider-educate-feedback .button-navigation-slider.next",
